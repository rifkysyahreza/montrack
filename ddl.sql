...
CREATE SEQUENCE montrack.wallet_id_seq
	...
	START 1
	CACHE 1
	NO CYCLE;-- montrack.goals definition
...
CREATE TABLE montrack.pocket (
	...
	"name" varchar NULL,
	allocated_amount numeric(12, 2) NULL,
	used_amount numeric(12, 2) NULL,
	description text NULL,
...
ALTER TABLE montrack."user" ADD CONSTRAINT fk_wallet_user FOREIGN KEY (wallet_id) REFERENCES montrack.wallet(id);


-- montrack.wallet foreign keys

ALTER TABLE montrack.wallet ADD CONSTRAINT fk_user_wallet FOREIGN KEY (user_id) REFERENCES montrack."user"(id);
